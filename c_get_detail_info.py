...
# 3rE4KuVNk8iZpbB5bPDZ1Qb6E9W0nRXV
    ...
    if req.status_code == 200:
        ...
        if total == 0:
            ...
            while item < int(page_num):
                ...
                page_url = 'http://api.map.baidu.com/place/v2/search?query=美食&page_size=20&page_num=' + str(
                    item) + '&scope=2&bounds=' + jw + '&output=json&ak=' + ak
                print page_url
                            ...
                            if 'uid' in shop:
                                ...
                                if 'detail_info' in shop:
                                    ...
                                    if 'comment_num' in detail_info:
                                        ...
                                        # print i, down_jw, up_jw, total, status, message, shop_name, shop_tel, shop_uid, shop_lat, shop_lng, shop_addr, street_id, detail
                                    sql = (
                                              "insert ignore into "
...
if __name__ == '__main__':
    ...
    thread = []
    for i in range(3):
        thread.append(myThread(i, "Thread-" + str(i)))
